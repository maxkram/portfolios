  ...
  render() {
    ...
    return (
      <BaseLayout
        ...
        title="Max Kramer - Newest Blogs to Read"
      >
        <div
          className="masthead"
                ...
                <div className="col-lg-8 col-md-10 mx-auto">
                  <ul className="list-inline text-center">
                    <li className="list-inline-item">
                      <a
                        target="_blank"
                        href="https://www.facebook.com/maksimkramer"
                      >
                    ...
                    <li className="list-inline-item">
                      <a target="_blank" href="https://github.com/maxkram">
                        <span className="fa-stack fa-lg">
                          <i className="fas fa-circle fa-stack-2x" />
                  ...
                  <p className="copyright text-muted">
                    Copyright &copy; Max Kramer 2019
                  </p>
                </div>
              </Row>
            </Container>
